package com.example.foodrecipes.presentation.widget;
...
public class FlowLayout extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < count; i++) {
           ...
           boolean newLine = lp.newLine || (mode != MeasureSpec.UNSPECIFIED && lineLength > size);
            if (newLine||newLineInBuyersInfo) {
    ...
    public void setNewLineBuyerCard(boolean newLineInBuyersInfo)
    {
        this.newLineInBuyersInfo=newLineInBuyersInfo;
    }
